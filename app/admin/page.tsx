            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  {negocio.id === 'lacancha' && <th className="p-4 text-left text-xs uppercase tracking-widest text-gray-500">Email</th>}
              ...
              <tbody>
                {turnosFiltrados.map((t) => (
                  <tr key={t.id} className="border-b border-white/5 hover:bg-white/5 transition">
                    ...
                    {negocio.id === 'lacancha' && <td className="p-4 text-gray-400 text-xs">{t.email_verificacion ?? '—'}</td>}
